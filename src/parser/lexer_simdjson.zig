/// simdjson-style two-phase lexer (STAGED — incremental port from lexer.zig).
///
...
/// helpers from lexer.zig so semantics stay identical.
///
/// Status (this commit): scaffold. Public API mirrors lexer.zig exactly.
/// Reuses pub helpers from lexer.zig (identEnd, stringEnd, etc.). Aim is
/// 47K-case differential parity before swapping default.
///
/// PoC numbers (bench/test_simdjson_phase1.zig): full Phase 1 + Phase 2
/// projected at ~9.2ms vs current 22ms (2.4×) on typescript.js.
