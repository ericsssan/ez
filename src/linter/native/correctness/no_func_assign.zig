...
// Rule: no-func-assign
// Source rule: tests/conformance/eslint/lib/rules/no-func-assign.js
...
pub fn runOnSymbols(ctx: *const LintContext) void {
    ...
    while (r < count) : (r += 1) {
        ...
        switch (symbols.getBindingKind(sym_id)) {
            .function_decl, .function_decl_annex_b, .fn_expr_name => {},
            else => continue,
        }
        ...
        ctx.reportWithMessageId(id_node, "isAFunction");
