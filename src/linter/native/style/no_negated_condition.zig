...
pub fn run(node: NodeIndex, ctx: *const LintContext) void {
    switch (ctx.nodeTag(node)) {
        .if_stmt, .if_else_stmt => {
            if (!(((ctx.nodeSkipGrouping(conditionalChild(ctx, node, .alternate)) != .none) and !(blk: { const __t = ctx.nodeTag(ctx.nodeSkipGrouping(conditionalChild(ctx, node, .alternate))); break :blk (__t == .if_stmt or __t == .if_else_stmt); })))) {
                return;
            }
            if (((blk: { const __t = ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)); break :blk (__t == .delete_expr or __t == .void_expr or __t == .typeof_expr or __t == .unary_plus or __t == .unary_minus or __t == .bitwise_not or __t == .logical_not); } and (ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)) == .logical_not)) or (blk: { const __t = ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)); break :blk (__t == .equal or __t == .not_equal or __t == .strict_equal or __t == .strict_not_equal or __t == .less_than or __t == .greater_than or __t == .less_equal or __t == .greater_equal or __t == .instanceof_expr or __t == .in_expr or __t == .add or __t == .subtract or __t == .multiply or __t == .divide or __t == .modulo or __t == .exponentiate or __t == .bitwise_and or __t == .bitwise_or or __t == .bitwise_xor or __t == .shift_left or __t == .shift_right or __t == .unsigned_shift_right); } and ((ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)) == .not_equal) or (ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)) == .strict_not_equal))))) {
                ctx.reportWithMessageId(node, "unexpectedNegated");
            }
        },
        .conditional => {
            if (((blk: { const __t = ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)); break :blk (__t == .delete_expr or __t == .void_expr or __t == .typeof_expr or __t == .unary_plus or __t == .unary_minus or __t == .bitwise_not or __t == .logical_not); } and (ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)) == .logical_not)) or (blk: { const __t = ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)); break :blk (__t == .equal or __t == .not_equal or __t == .strict_equal or __t == .strict_not_equal or __t == .less_than or __t == .greater_than or __t == .less_equal or __t == .greater_equal or __t == .instanceof_expr or __t == .in_expr or __t == .add or __t == .subtract or __t == .multiply or __t == .divide or __t == .modulo or __t == .exponentiate or __t == .bitwise_and or __t == .bitwise_or or __t == .bitwise_xor or __t == .shift_left or __t == .shift_right or __t == .unsigned_shift_right); } and ((ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)) == .not_equal) or (ctx.nodeTag(ctx.nodeSkipGrouping(ctx.nodeData(node).lhs)) == .strict_not_equal))))) {
