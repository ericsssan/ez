...
pub const Parser = struct {
    ...
    pub fn parseStatement(self: *Parser) Error!NodeIndex {
        ...
        switch (self.peek()) {
            ...
            .kw_var, .kw_const => return self.parseVariableDeclaration(),
            .kw_let => {
            ...
            .kw_import => {
                ...
                } else if (self.in_block or self.in_function or self.in_loop or self.in_switch) {
    ...
    pub const typescript = @import("parser/typescript.zig");
    pub const jsx = @import("parser/jsx.zig");
