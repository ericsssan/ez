...
const rule = require("../../node_modules/eslint-plugin-sonarjs").rules["expression-complexity"];
...
ruleTester.run("expression-complexity", rule, {
  valid: [
    { code: "if (a) { if (b) { foo(); } }" },
    { code: "if (a && b) { foo(); }" },
  ...
  invalid: [
    { code: "function f() { return a && b && c && d && e && f && g; }" },
  ],
});
